...
public:
    ...
    int getCellValue(int row, int col) const; // get a value of a cell at any position
    void setCellValue(int row, int col, int value); // set a value of a cell at any position
};
